...
export default function RebrandEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Today, we're thrilled to announce our rebrand. letsfind.my is now letsfind.my.
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              <Link
                href="https://letsfind.my/blog/rebrand"
            ...
            <Text className="ml-1 text-sm leading-6 text-black">
              ◆{" "}
              <Link
                href="https://letsfind.my/blog/migration-assistants"
            ...
            <Text className="text-sm leading-6 text-black">
              Check out our{" "}
              <Link
                href="https://letsfind.my/changelog"
                className="font-medium text-blue-600 no-underline"
              >
                changelog
              </Link>{" "}
