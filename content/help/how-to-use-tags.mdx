...
Currently, we only support assigning one tag to a link. If you're interested in the ability to assign multiple tags to a link, please let us know by [creating an issuue here](https://letsfind.my/issues).
...
<Note variant="warning">
  **Note**: You cannot create any tags when using `letsfind.my` links.
</Note>
