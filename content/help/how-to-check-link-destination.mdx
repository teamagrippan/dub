...
For example, if you want to check the destination of the short link `letsfind.my/github`, you can type `letsfind.my/github+` into your browser's address bar and press `Enter`.
