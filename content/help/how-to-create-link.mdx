...
## letsfind.my links vs custom domain links

When you sign up for Dub, you have the option to choose between the default `letsfind.my` domain or your own custom domain to create short links.

<Image
  alt="Onboarding screen where you can choose between letsfind.my links or custom domain links"
...
|                        | Default `letsfind.my` links                                            | Custom domain links                                                                                                                                                                       |
| ---------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Dashboard location** | [app.letsfind.my/links](https://app.letsfind.my/links)                      | Can be found in the project select menu at the top menu bar                                                                                                                               |
...
<Image
  alt="Masking 'slack.com' with 'letsfind.my/slack'"
...
Here's a demo: [letsfind.my/password](https://letsfind.my/password) (password is `dub`)
