---
title: Introducing letsfind.my – the new face of Dub
publishedAt: 2023-08-21
summary: We're thrilled to announce our rebrand. letsfind.my is now letsfind.my.
...
## Our New Brand: letsfind.my

As we grew, we realized that our existing brand, _letsfind.my_, was not ideal.
...
After months of brainstorming, we finally found the perfect name: **letsfind.my**.

## What's new in letsfind.my?

Our rebrand is more of a facelift than a complete overhaul. We're still the same Dub you know and love, but with a new domain. We will still be using `letsfind.my` as the default short link domain on Dub, and all existing `letsfind.my` links will continue to work as usual.
...
Dub is here to stay and we're committed to making it the best link shortener for everyone, everywhere. We invite you to join us on this journey by [creating a free account](https://app.letsfind.my/register) today.
