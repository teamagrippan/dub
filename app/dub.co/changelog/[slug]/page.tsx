      ...
      <div className="flex flex-col space-y-8 md:col-span-3">
        ...
        <div className="mx-5 mb-10 flex items-center justify-between md:mx-0">
          ...
          <div className="flex items-center space-x-6">
            <Link
              href={`https://twitter.com/intent/tweet?text=${post.title}&url=https://letsfind.my/changelog/${post.slug}&via=${post.author}`}
              target="_blank"
            ...
            <Link
              href={`
            http://www.linkedin.com/shareArticle?mini=true&url=https://letsfind.my/changelog/${post.slug}`}
              target="_blank"
              rel="noopener noreferrer"
              className="transition-all hover:scale-110"
            >
            ...
            <Link
              href={`https://www.facebook.com/sharer/sharer.php?u=https://letsfind.my/changelog/${post.slug}`}
              target="_blank"
              rel="noopener noreferrer"
              className="transition-all hover:scale-110"
            >
